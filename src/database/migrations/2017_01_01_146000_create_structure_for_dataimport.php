...
class CreateStructureForDataImport extends StructureMigration
{
    ...
    protected $permissions = [
        ...
        ['name' => 'import.initTable', 'description' => 'Init table for imports', 'type' => 0, 'default' => false],
        ['name' => 'import.getTableData', 'description' => 'Table data for imports', 'type' => 0, 'default' => false],
        ['name' => 'import.exportExcel', 'description' => 'Export excel for imports', 'type' => 0, 'default' => false],
    ...
    protected $menu = [
        'name' => 'Data Import', 'icon' => 'cloud-upload-alt', 'link' => 'import.index', 'order' => 999, 'has_children' => false,
    ];
